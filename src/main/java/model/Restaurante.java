...
public class Restaurante {
    ...
    public void mostrarMesas() {
        for (Mesa mesa : mesas) {
            ...
            String clienteInfo = mesa.isOcupada() ? ", Model.Cliente: " + mesa.getCliente().getNome() + ", Pessoas: " + mesa.getCliente().getNumPessoas() : "";
            System.out.println("Model.Mesa ID: " + mesa.getId() + ", Capacidade: " + mesa.getCapacidade() + ", Status: " + status + clienteInfo);
        }
    }
    ...
    public void mostrarComandas() {
        for (Mesa mesa : mesas) {
            if (mesa.isOcupada()) {
                System.out.println("Model.Mesa ID: " + mesa.getId() + " - Model.Pedido:");
                ...
                System.out.println("Model.Mesa ID: " + mesa.getId() + " - Nenhum cliente.");
            }
        }
    }
}
