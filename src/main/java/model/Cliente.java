...
public class Cliente {
    ...
    public void sairDoRestaurante() {
        if (this.requisicao != null && this.requisicao.getMesa() != null) {
            ...
            System.out.println("Model.Cliente " + nome + " concluiu sua refeição e desocupou a mesa " + this.requisicao.getMesa().getId() + ".");
        } else {
            System.out.println("Model.Cliente " + nome + " não está em uma mesa.");
        }
    }
}
